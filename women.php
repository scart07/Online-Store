...
<html>
	...
	<body>
		...
		<nav id="Category_Filter" >
			...
			<a href="women.php?id=<?php echo "1234"; ?>"><h3>Footwear</h3></a>
			<ul type="none" class="Filter_List">
				<a href="women.php?id=<?php echo "1"; ?>"><li>LIFESTYLE</li></a>
				<a href="women.php?id=<?php echo "2"; ?>"><li>RUNNING</li></a>
				<a href="women.php?id=<?php echo "3"; ?>"><li>SOCCER</li></a>
				<a href="women.php?id=<?php echo "4"; ?>"><li>BASKETBALL</li></a>
			</ul>
			<br>

			<a href="women.php?id=<?php echo "567"; ?>"><h3>Clothing</h3></a>
			
			<ul type="none" class="Filter_List">
				<a href='women.php?id=<?php echo "5"; ?>'><li>Jacket & Hoodies</li></a>
				<a href='women.php?id=<?php echo "6"; ?>'><li>T-Shirts</li></a>
				<a href='women.php?id=<?php echo "7"; ?>'><li>Jerseys</li></a>
			</ul>
			<br>
			
			<a href='women.php?id=<?php echo "89"; ?>'><h3>Accessories</h3>
			<ul type="none" class="Filter_List">
				<a href='women.php?id=<?php echo "8"; ?>'><li>BAGS</li></a>
				<a href='women.php?id=<?php echo "9"; ?>'><li>SOCKS</li></a>
				<a href="#Bottles"><li>BOTTLES</li></a>
			</ul>

			<ul type="none" >
				<a href='women.php?id=<?php echo ""; ?>'><li><input type="button" value="RESET FILTER" ></li></a>
			</ul>
