		...
		<main>
				<section id="display_content">
					<table id="content_table">
						...
						<!- php for displaying women hoodies-!>
						<?php							
						...
						<!- php for displaying womens jerseys-!>
						<?php							
						...
						<!- php for displaying women soccer boots-!>
						<?php							
						...
						<!- php for displaying women basketball shoes-!>
						<?php							
						...
						<!- php for displaying women T-shirts-!>
						<?php							
						...
						<!- php for displaying women LifestyleShoes-!>
						<?php							
						...
						<!- php for displaying women RunningShoes-!>
						<?php							
						...
						<!- php for displaying women socks-!>
						<?php							
